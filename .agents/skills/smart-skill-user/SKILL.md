...
description: Token-aware preflight router that automatically chooses the best skill or smallest effective skill stack before Claude Code starts work.
---

# Smart Skill User

Use this skill before Claude Code starts implementation, review, validation, cleanup, connector work, or release work. Its core behavior is to automatically choose the best skill or best skill stack before work begins.

One skill when one is enough. A stack when the task needs more.

## Smart Skill Preflight

Begin every Claude Code task or session with a concise preflight:
