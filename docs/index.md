...
- [Top 13 Skills](TOP_SKILLS.md): curated companion skills — token savers, SEO/marketing depth, Karpathy guardrails, plus May 2026 trending additions (graphify, claude-blog, claude-ads). Install with `bash scripts/install-top-skills.sh`.
