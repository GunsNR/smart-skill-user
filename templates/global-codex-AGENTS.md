...
Before starting a coding task, run Smart Skill Preflight:
...
Stop and ask if scope is unclear. Do not deploy, publish, modify production connectors, perform destructive cleanup, or expose private data without explicit approval.
